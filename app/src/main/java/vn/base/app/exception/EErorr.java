...
public enum EErorr {
    ...
    BAD_REQUEST_TYPE_MISMATCH(HttpStatus.BAD_REQUEST, "Incorrect passed data type"),
    BAD_REQUEST_FORMAT_MISMATCH(HttpStatus.BAD_REQUEST, "Incorrect passed data format"),
